...
=> 預處理：$ gcc –E helloCTFer.c –o helloCTFer.i  查看 .i 的架構
=> 編譯：$ gcc –S helloCTFer.i  -o helloCTFer.s   查看 .s 的架構
=> 彙編：$ gcc -c helloCTFer.s -o helloCTFer.o    查看 .o 的架構
=> 連結：$ gcc  helloCTFer.o -o helloCTFer        查看 helloCTFer 的架構
```
